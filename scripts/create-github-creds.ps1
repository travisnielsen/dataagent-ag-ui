...
az ad app create --display-name "github-actions-agui"

# Get the app ID
$APP_ID = az ad app list --display-name "github-actions-agui" --query "[0].appId" -o tsv
...
az ad app federated-credential create --id $APP_ID `
  --parameters '{
    ...
    "subject": "repo:travisnielsen/dataagent-ag-ui:ref:refs/heads/main",
