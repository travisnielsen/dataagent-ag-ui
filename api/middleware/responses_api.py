...
from agent_framework._types import ChatResponse, ChatResponseUpdate, FunctionCallContent, FunctionResultContent, Role
        ...
        if ended_with_frontend:
            ...
            if agui_thread_id and last_response_id:
                if last_response_id.startswith(("resp_", "conv_")):
                    ...
                    logger.debug("[ResponsesApiThreadMiddleware] Stored response_id %s for thread %s (awaiting tool result)", last_response_id, agui_thread_id)
